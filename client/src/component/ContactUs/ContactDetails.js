import { faComment, faEnvelope, faLocationDot, faPhone } from "@fortawesome/free-solid-svg-icons";
	...
	return(
		<React.Fragment>
			<div className={` ${classes.ContactDetails} container p-0`} >
				...
				<div className='mt-2'>
					<FontAwesomeIcon icon={faLocationDot} className={classes.ContactIcon} />
					<p> Company Address </p>
				...
				<div className='mt-2'>
					...
					<Link className={`${classes.ChatNow} `} to='/'> Chat Now </Link>
				</div>
